...
*/
export function wasm_renderer(): Promise<void>;
/**
* @returns {number}
*/
...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h07bcebc0083a98bb: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hc734b71fbb4bd13d: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h1d2ef5556480a6a1: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h8e76fe93b4b21957: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h3acb255587e8f8c8: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__hbec97f40e8f6aa8d: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h2b6453104e25db77: (a: number, b: number, c: number, d: number) => void;
